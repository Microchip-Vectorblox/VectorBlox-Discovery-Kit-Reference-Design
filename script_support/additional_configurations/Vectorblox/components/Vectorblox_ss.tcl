...
sd_create_bus_port -sd_name ${sd_name} -port_name {SLAVE0_BID} -port_direction {IN} -port_range {[4:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {SLAVE0_RID} -port_direction {IN} -port_range {[4:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {SLAVE0_ARID} -port_direction {OUT} -port_range {[4:0]}
...
sd_create_bus_port -sd_name ${sd_name} -port_name {SLAVE0_AWID} -port_direction {OUT} -port_range {[4:0]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EXT_RST_N" "fast_reset:EXT_RST_N" "slow_reset:EXT_RST_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"INIT_DONE" "fast_reset:INIT_DONE" "slow_reset:INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C1_0:OUT0_FABCLK_0" "aclk_control" "core_vectorblox_C0_0:clk" "slow_reset:CLK" "vectorblox_axi_resize_0:M_CLK0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C1_0:OUT1_FABCLK_0" "aclk" "core_vectorblox_C0_0:clk_2x" "core_vectorblox_C0_0:clk_cnn" "fast_reset:CLK" "vectorblox_axi_resize_0:ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"PF_CCC_C1_0:PLL_LOCK_0" "fast_reset:PLL_LOCK" "slow_reset:PLL_LOCK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"fast_reset:FABRIC_RESET_N" "vectorblox_axi_resize_0:ARESETN" }


# Add bus interface net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"AXIM" "vectorblox_axi_resize_0:AXI4mslave0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"S_control" "core_vectorblox_C0_0:S_control" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"core_vectorblox_C0_0:M0_AXI" "vectorblox_axi_resize_0:AXI4mmaster0" }
